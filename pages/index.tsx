...
const Home: NextPage = () => {
  ...
  */
  const [currUploadReq, setCurrUploadReq] = useState<tus.HttpRequest | null>(
    null
  );
  ...
  return (
    <Wrapper>
      ...
      <div className="btn-wrapper">
        <button className="cancel-btn" onClick={uploadCancelHandler}>
          Cancel
        </button>
        <button className="pause-btn" onClick={uploadPauseHandler}>
          Pause
        </button>
        <button className="resume-btn" onClick={uploadResumeHandler}>
          {uploadState === "Paused" ? "Resume" : "Start"}
        </button>
      </div>
